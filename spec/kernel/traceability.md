...
| REQ-LLM-005 | `MacParakeetCore/AppRuntimePreferences.swift`, `MacParakeetCore/TextProcessing/AIFormatter.swift`, `MacParakeetCore/Services/TranscriptionService.swift`, `MacParakeet/App/AppEnvironment.swift`, `MacParakeetViewModels/LLMSettingsViewModel.swift`, `MacParakeet/Views/Settings/LLMSettingsView.swift` | `AppRuntimePreferencesTests.swift`, `TranscriptionServiceTests.swift`, `LLMSettingsViewModelTests.swift` |
...
| REQ-MEET-014 | `MacParakeetCore/MeetingRecordingFlow/MeetingRecordingFlowStateMachine.swift`, `MacParakeetCore/Services/MeetingRecording/MeetingRecordingService.swift`, `MacParakeet/App/MeetingRecordingFlowCoordinator.swift`, `MacParakeet/Views/MeetingRecording/MeetingRecordingPillController.swift`, `MacParakeet/Views/MeetingRecording/MeetingRowCard.swift`, `MacParakeet/Views/Transcription/MeetingRecordingTile.swift`, `MacParakeetViewModels/MeetingRecordingPillViewModel.swift` | `MeetingRecordingFlowStateMachineTests.swift`, `MeetingRecordingServiceTests.swift` |

## v0.6 Multilingual Speech Recognition

| Requirement | Source Files | Test Files |
|------------|-------------|------------|
| REQ-STT-002 | `MacParakeetCore/SpeechEnginePreference.swift`, `MacParakeetCore/STT/ParakeetModelVariant+ASR.swift`, `MacParakeetCore/STT/NemotronEngine.swift`, `MacParakeetCore/STT/WhisperEngine.swift`, `MacParakeetCore/STT/STTRuntime.swift`, `MacParakeetCore/STT/STTScheduler.swift`, `MacParakeetCore/Services/Dictation/DictationService.swift`, `Package.swift` | `STTClientTests.swift`, `SpeechEnginePreferenceTests.swift`, `ModelDeletionTests.swift`, `STTSchedulerTests.swift`, `DictationServiceTests.swift` |
