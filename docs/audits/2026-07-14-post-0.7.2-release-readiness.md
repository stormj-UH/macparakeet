...
> **Release correction (2026-07-16):** The #775 in-app CLI installer reviewed
> below was removed before 0.7.3 publication by PR #827 after signed-app QA
> exposed the real `/usr/local/bin` permission and Homebrew coexistence costs.
> Its row is retained as point-in-time review history, not current product
> behavior. The governing disposition is recorded in
> `2026-07-16-v0.7.3-comprehensive-codebase-release-architecture-audit.md`.
